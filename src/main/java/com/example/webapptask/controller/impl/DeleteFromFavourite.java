...
public class DeleteFromFavourite implements Command {
    ...
    private static final String ERROR_ADD_PARAM = "err_delete";
    private static final String SUCCESS_ADD_PARAM = "suc_delete";
    ...
    public void execute(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        try {
            if (NEWS_SERVICE.deleteFromFavourite(userId, newsId)) {
            ...
            log.error("error adding on favorite news");
